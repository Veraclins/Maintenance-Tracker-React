      ...
      <div className="content_banner_inner">
        ...
        <div className="container">
          ...
          >
            ...
            <h5>
              VeraTech gives you the peace of mind you need. We care for your devices so
    ...
    <div className="content_section_1 section_viewer" data-section="deliver">
      ...
      <div className="container">
        <div className="inner_layout">
          <div className="techinical_layout_left">
            <div className="pipe_row pipe_left">
          ...
          <div className="techinical_layout_right ">
            ...
            <div className="pipe_row pipe_right">
              <div className="pipe_column">
                <h2>
    ...
    <div className="content_section_2 section_viewer" data-section="skills">
      <div className="container">
        <div className="layout_content wow fadeInUp" data-wow-offset="150">
          ...
          <p>
            Our approach to repairs is rooted in deep understanding of the devices.
            Nothing is to complex to be fixed. The world’s toughest problems are
    ...
    <div className="content_section_4 section_viewer" data-section="online">
      <div className="container">
        <div className="layout_content wow fadeInUp" data-wow-offset="150">
          ...
          <p>
            We’re fluent in distributed work, but nothing quite replaces
            face-to-face interactions. That’s why our developers and partners
            meet in person at least once a year, preferably within the first 90
          ...
          <div className="timeline_buttons_section">
            ...
            <div className="timeline_buttons timeline_button_right">
              <div className="wow fadeInRight">
                {' '}
                <Link
                  to="https://andela.com/fellowship/"
                  className="buttons button_blank"
                >
                  LOGIN TO YOUR ACCOUNT
                </Link>
