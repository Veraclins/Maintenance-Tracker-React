...
describe('GET request to /api/v1/requests', () => {
  ...
  it('should return all requests in the database for an admin', (done) => {
    chai.request(server)
      .get('/api/v1/requests')
  ...
  it('should return forbidden if the user is not an admin', (done) => {
    chai.request(server)
      .get('/api/v1/requests')
...
describe('PUT request to /api/v1/requests/4/resolve', () => {
  ...
  it('should return status 400 and an error message when the id provided is not a number', (done) => {
    chai.request(server)
      .put('/api/v1/requests/love/resolve')
      .set('x-access-token', adminToken)
      .send({
        title: 'General repainting',
        description: `Check to see if the array has a length of 0. 
